...
if ($result) {
    echo "<script>alert('Added Successful'); window.location.href='customization.php';</script>";

} else {
    echo "<script>alert('Addition Failed'); window.location.href='customization.php';</script>";
